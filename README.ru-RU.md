...
* Частоты приёма: 0 MHz - 750 MHz с затуханиями каждые 61.44 MHz (выше 145мгц - без входных фильтров)
...
* Поддержка разных дисплеев: RA8875/HX8357B/HX8357C/ST7789/ST7796S/ST7735S/ILI9341/ILI9481/ILI9486
...
* **CW In SSB** - Разрешает манипуляцию CW на передачу в SSB моде
