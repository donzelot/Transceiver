...
extern void BUTTONHANDLER_TANGENT_A(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_B(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_C(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_D(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_1(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_2(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_3(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_4(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_5(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_6(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_7(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_8(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_9(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_0(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_STAR(uint32_t parameter);
extern void BUTTONHANDLER_TANGENT_JAIL(uint32_t parameter);
